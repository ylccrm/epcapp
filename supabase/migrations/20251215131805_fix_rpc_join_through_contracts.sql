/*
  # Fix RPC Join Through Contracts Table

  This migration fixes the join to calculate average progress correctly through the contracts table.

  ## Changes Made

  1. **Fix JOIN Chain**
     - Join projects -> contracts -> contract_payment_milestones
     - Use correct column names that exist in the schema

  2. **Calculate Progress**
     - Average progress from contract_payment_milestones through contracts
     - Handle NULL values with COALESCE

  ## Fixed Issues
  - Incorrect JOIN causing "column does not exist" error
  - Now uses proper table relationships
*/
